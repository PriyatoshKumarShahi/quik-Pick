...
// document.querySelector('.hero-btn a').addEventListener('click', function(event) {
//   event.preventDefault();
//   document.querySelector('#products').scrollIntoView({
//     behavior: 'smooth'
//   });
// });
// document.querySelector('.more-products a').addEventListener('click', function(event) {
//   event.preventDefault();
//   document.querySelector('#moreproducts').scrollIntoView({
//     behavior: 'smooth'
//   });
// });
